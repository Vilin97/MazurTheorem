...
omit [GeometricallyIrreducible C.hom] in
/-- On the final pointed-incidence refinement, quotienting the complete
family of support summands by the pulled-back universal coordinate-graph
product gives a finite free algebra of rank the original ordered degree.
This is the named incidence consumer of the refined monic-root quotient
calculation. -/
theorem orderedSupportGeometricAssigned_refinedCoordinateGraphQuotientAlgebra_finrank
    (d : ℕ) (z : (orderedAmbient (Spec (.of K)) d C).left)
    {V : (commonAffineBase K C d
      (orderedSupportPoint K C d z)).left.Opens}
    (hVs : (GeometricAssignedAffineChart.action K C d
    ...
    Module.finrank Γ(R.baseOpen.toScheme, ⊤)
        (R.refinedCoordinateGraphQuotientAlgebra K C d
...
omit [GeometricallyIrreducible C.hom] in
/-- On the final pointed-incidence refinement, the quotient by the genuine
pullback of the universal ordered-incidence ideal is finite free of rank the
original ordered degree.  This is the named consumer of the arbitrary ideal-
sheaf pullback and refined-coproduct comparison. -/
theorem orderedSupportGeometricAssigned_refinedOrderedIncidenceQuotient_finrank
    (d : ℕ) (z : (orderedAmbient (Spec (.of K)) d C).left)
    {V : (commonAffineBase K C d
      (orderedSupportPoint K C d z)).left.Opens}
    (hVs : (GeometricAssignedAffineChart.action K C d
    ...
    (R : CrossSupportAffineGraphRefinement K C d
      (orderedSupportPoint K C d z) hVs q m E hE N) :
    Module.finrank Γ(R.baseOpen.toScheme, ⊤)
        (R.refinedCoproductOrderedIncidenceQuotient K C d
          (orderedSupportPoint K C d z) hVs q m E hE N) = d :=
  R.refinedCoproductOrderedIncidenceQuotient_finrank K C d
    (orderedSupportPoint K C d z) hVs q m E hE N
...
theorem orderedSupportGeometricAssigned_graphProduct_top_eq_map
    (d : ℕ) (z : (orderedAmbient (Spec (.of K)) d C).left)
    {V : (commonAffineBase K C d
      (orderedSupportPoint K C d z)).left.Opens}
    (hVs : (GeometricAssignedAffineChart.action K C d
    ...
    (a : Fin (geometricDistinctSupportCard K C d
      (orderedSupportPoint K C d z))) :
    (supportPieceGraphProductIdeal K C d
        (orderedSupportPoint K C d z) hVs q m E hE N a).ideal
        ⟨⊤, @isAffineOpen_top _
          (supportPiece_isAffine K C d
            (orderedSupportPoint K C d z) hVs q m E hE N a)⟩ =
      Ideal.map
        (pullback.fst
          ((N.supportOpen a).ι ≫
            supportAmbientToBase K C d
              (orderedSupportPoint K C d z) hVs q a)
          N.baseOpen.ι).appTop.hom
        ((supportOpenGraphProductIdeal K C d
            (orderedSupportPoint K C d z) hVs q m E hE N a).ideal
          ⟨⊤, @isAffineOpen_top _ (N.support_isAffine a)⟩) :=
  supportPieceGraphProductIdeal_top_eq_map K C d
    (orderedSupportPoint K C d z) hVs q m E hE N a

omit [GeometricallyIrreducible C.hom] [IsProper C.hom] in
/-- On an ordered-incidence affine support block, the complete geometric
graph product is the pullback of the product of its independently varying
affine-line section ideals. -/
theorem orderedSupportGeometricAssigned_graphProduct_eq_coordinate_comap
    (d : ℕ) (z : (orderedAmbient (Spec (.of K)) d C).left)
    {V : (commonAffineBase K C d
      (orderedSupportPoint K C d z)).left.Opens}
    (hVs : (GeometricAssignedAffineChart.action K C d
    ...
    supportPieceGraphProductIdeal K C d
        (orderedSupportPoint K C d z) hVs q m E hE N a =
      (supportAffineLineGraphProductIdeal K C d
        (orderedSupportPoint K C d z) hVs q m E hE N a).comap
        (supportPieceToSupportAffineLine K C d
          (orderedSupportPoint K C d z) hVs q m E hE N a) :=
  supportPieceGraphProductIdeal_eq_coordinateSection_comap K C d
    (orderedSupportPoint K C d z) hVs q m E hE N a
...
omit [GeometricallyIrreducible C.hom] [IsProper C.hom] in
/-- On the final simultaneous affine neighborhood of an ordered incidence
point, the product of all support-block graph quotients is finite flat of
rank `d`.  This is the pointwise incidence consumer of the monic
section-product calculation; coincident ordered coordinates still contribute
separate linear factors and hence their full multiplicity to the rank. -/
theorem orderedSupportGeometricAssigned_supportGraphProduct_finiteFlat_rank
    (d : ℕ) (z : (orderedAmbient (Spec (.of K)) d C).left)
    {V : (commonAffineBase K C d
      (orderedSupportPoint K C d z)).left.Opens}
    (hVs : (GeometricAssignedAffineChart.action K C d
    ...
    [IsAffine (componentFpqcBlockRefinement K C d
      (orderedSupportPoint K C d z) hVs q).left] :
    let A := supportGraphProductQuotientAlgebra K C d
      (orderedSupportPoint K C d z) hVs q m E hE N
    Module.Finite Γ(N.baseOpen.toScheme, ⊤) A ∧
      Module.Flat Γ(N.baseOpen.toScheme, ⊤) A ∧
      Module.finrank Γ(N.baseOpen.toScheme, ⊤) A = d := by
  dsimp only
  exact ⟨inferInstance, inferInstance,
    supportGraphProductQuotientAlgebra_finrank K C d
      (orderedSupportPoint K C d z) hVs q m E hE N⟩

omit [GeometricallyIrreducible C.hom] [IsProper C.hom] in
/-- At an ordered incidence point, the quotient formed on the actual affine
support coproduct is finite flat of rank `d`.  Thus the local rank theorem is
attached to the geometric coproduct itself, not only to its auxiliary
product-of-section-rings presentation. -/
theorem orderedSupportGeometricAssigned_supportCoproductGraphProduct_finiteFlat_rank
    (d : ℕ) (z : (orderedAmbient (Spec (.of K)) d C).left)
    {V : (commonAffineBase K C d
      (orderedSupportPoint K C d z)).left.Opens}
    (hVs : (GeometricAssignedAffineChart.action K C d
    ...
    [IsAffine (componentFpqcBlockRefinement K C d
      (orderedSupportPoint K C d z) hVs q).left] :
    let A := supportCoproductGraphProductQuotient K C d
      (orderedSupportPoint K C d z) hVs q m E hE N
    Module.Finite Γ(N.baseOpen.toScheme, ⊤) A ∧
      Module.Flat Γ(N.baseOpen.toScheme, ⊤) A ∧
      Module.finrank Γ(N.baseOpen.toScheme, ⊤) A = d := by
  dsimp only
  exact ⟨inferInstance, inferInstance,
    supportCoproductGraphProductQuotient_finrank K C d
      (orderedSupportPoint K C d z) hVs q m E hE N⟩

omit [GeometricallyIrreducible C.hom] [IsProper C.hom] in
/-- At an ordered-incidence point, the assembled support-coproduct ideal is
the intrinsic scheme-theoretic product of the kernels of every ordered
occurrence graph, grouped by its geometric support owner. -/
theorem orderedSupportGeometricAssigned_supportCoproductGraphProductIdeal_eq_kernels
    (d : ℕ) (z : (orderedAmbient (Spec (.of K)) d C).left)
    {V : (commonAffineBase K C d
      (orderedSupportPoint K C d z)).left.Opens}
    (hVs : (GeometricAssignedAffineChart.action K C d
    ...
    [IsAffine (componentFpqcBlockRefinement K C d
      (orderedSupportPoint K C d z) hVs q).left] :
    supportCoproductGraphProductIdeal K C d
        (orderedSupportPoint K C d z) hVs q m E hE N =
      ∏ a : ULift.{u} (Fin (geometricDistinctSupportCard K C d
          (orderedSupportPoint K C d z))),
        ∏ i : OccurrencesAtSupport K C d
          (orderedSupportPoint K C d z) (Equiv.ulift.{u} a),
          (graphToSupportCoproduct K C d
            (orderedSupportPoint K C d z) hVs q m E hE N
              (Equiv.ulift.{u} a) i).ker := by
  exact (supportCoproductOccurrenceGraphProductIdeal_eq_assembled K C d
    (orderedSupportPoint K C d z) hVs q m E hE N).symm
