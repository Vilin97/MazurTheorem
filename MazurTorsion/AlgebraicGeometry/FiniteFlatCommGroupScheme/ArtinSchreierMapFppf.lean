...
noncomputable def artinSchreierCoordinateBialgHom :
  ...
  BialgHom.ofAlgHom (artinSchreierAlgHom p)
    ...
    (by
      apply SymmetricAlgebra.algHom_ext
      apply LinearMap.ext_ring
      simp only [LinearMap.coe_comp, LinearMap.coe_coe, AlgHom.coe_comp,
        Function.comp_apply, Bialgebra.comulAlgHom_apply, comul_ι, map_add,
        Algebra.TensorProduct.map_tmul, map_one]
      rw [artinSchreierAlgHom_generator, map_sub,
