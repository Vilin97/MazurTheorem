...
def recurrence6ResidualBand0 : Coefficient :=
  normalizedResidual6Term1Block0 -
    normalizedResidual6Term2Block0 +
    normalizedResidual6Term3Block0

theorem recurrence6ResidualBand0_eq : recurrence6ResidualBand0 = 0 := by
...
def recurrence6ResidualBand1 : Coefficient :=
  normalizedResidual6Term1Block1 -
    normalizedResidual6Term2Block1 +
    normalizedResidual6Term3Block1

theorem recurrence6ResidualBand1_eq : recurrence6ResidualBand1 = 0 := by
...
def recurrence6ResidualBand2 : Coefficient :=
  normalizedResidual6Term1Block2 -
    normalizedResidual6Term2Block2 +
    normalizedResidual6Term3Block2

theorem recurrence6ResidualBand2_eq : recurrence6ResidualBand2 = 0 := by
...
def recurrence6ResidualBand3 : Coefficient :=
  normalizedResidual6Term1Block3 -
    normalizedResidual6Term2Block3 +
    normalizedResidual6Term3Block3

theorem recurrence6ResidualBand3_eq : recurrence6ResidualBand3 = 0 := by
...
def recurrence6ResidualBand4 : Coefficient :=
  normalizedResidual6Term1Block4 -
    normalizedResidual6Term2Block4 +
    normalizedResidual6Term3Block4

theorem recurrence6ResidualBand4_eq : recurrence6ResidualBand4 = 0 := by
...
def recurrence6ResidualBand5 : Coefficient :=
  normalizedResidual6Term1Block5 -
    normalizedResidual6Term2Block5 +
    normalizedResidual6Term3Block5

theorem recurrence6ResidualBand5_eq : recurrence6ResidualBand5 = 0 := by
...
def recurrence6ResidualBand6 : Coefficient :=
  normalizedResidual6Term1Block6 -
    normalizedResidual6Term2Block6 +
    normalizedResidual6Term3Block6

theorem recurrence6ResidualBand6_eq : recurrence6ResidualBand6 = 0 := by
...
def recurrence6ResidualBand7 : Coefficient :=
  normalizedResidual6Term1Block7 -
    normalizedResidual6Term2Block7 +
    normalizedResidual6Term3Block7

theorem recurrence6ResidualBand7_eq : recurrence6ResidualBand7 = 0 := by
...
def recurrence6ResidualBand8 : Coefficient :=
  normalizedResidual6Term1Block8 -
    normalizedResidual6Term2Block8 +
    normalizedResidual6Term3Block8

theorem recurrence6ResidualBand8_eq : recurrence6ResidualBand8 = 0 := by
...
def recurrence6ResidualBand9 : Coefficient :=
  normalizedResidual6Term1Block9 -
    normalizedResidual6Term2Block9 +
    normalizedResidual6Term3Block9

theorem recurrence6ResidualBand9_eq : recurrence6ResidualBand9 = 0 := by
...
def recurrence6ResidualBand10 : Coefficient :=
  normalizedResidual6Term1Block10 -
    normalizedResidual6Term2Block10 +
    normalizedResidual6Term3Block10

theorem recurrence6ResidualBand10_eq : recurrence6ResidualBand10 = 0 := by
...
def recurrence6ResidualBand11 : Coefficient :=
  normalizedResidual6Term1Block11 -
    normalizedResidual6Term2Block11 +
    normalizedResidual6Term3Block11

theorem recurrence6ResidualBand11_eq : recurrence6ResidualBand11 = 0 := by
...
def recurrence6ResidualBand12 : Coefficient :=
  normalizedResidual6Term1Block12 -
    normalizedResidual6Term2Block12 +
    normalizedResidual6Term3Block12

theorem recurrence6ResidualBand12_eq : recurrence6ResidualBand12 = 0 := by
...
def recurrence6ResidualBand13 : Coefficient :=
  normalizedResidual6Term1Block13 -
    normalizedResidual6Term2Block13 +
    normalizedResidual6Term3Block13

theorem recurrence6ResidualBand13_eq : recurrence6ResidualBand13 = 0 := by
...
def recurrence6ResidualBand14 : Coefficient :=
  normalizedResidual6Term1Block14 -
    normalizedResidual6Term2Block14 +
    normalizedResidual6Term3Block14

theorem recurrence6ResidualBand14_eq : recurrence6ResidualBand14 = 0 := by
...
def recurrence6ResidualBand15 : Coefficient :=
  normalizedResidual6Term1Block15 -
    normalizedResidual6Term2Block15 +
    normalizedResidual6Term3Block15

theorem recurrence6ResidualBand15_eq : recurrence6ResidualBand15 = 0 := by
...
def recurrence6ResidualBand16 : Coefficient :=
  normalizedResidual6Term1Block16 -
    normalizedResidual6Term2Block16 +
    normalizedResidual6Term3Block16

theorem recurrence6ResidualBand16_eq : recurrence6ResidualBand16 = 0 := by
...
def recurrence6ResidualBand17 : Coefficient :=
  normalizedResidual6Term1Block17 -
    normalizedResidual6Term2Block17 +
    normalizedResidual6Term3Block17

theorem recurrence6ResidualBand17_eq : recurrence6ResidualBand17 = 0 := by
...
def recurrence6ResidualBand18 : Coefficient :=
  normalizedResidual6Term1Block18 -
    normalizedResidual6Term2Block18 +
    normalizedResidual6Term3Block18

theorem recurrence6ResidualBand18_eq : recurrence6ResidualBand18 = 0 := by
...
def recurrence6ResidualBand19 : Coefficient :=
  normalizedResidual6Term1Block19 -
    normalizedResidual6Term2Block19 +
    normalizedResidual6Term3Block19

theorem recurrence6ResidualBand19_eq : recurrence6ResidualBand19 = 0 := by
...
def recurrence6ResidualBand20 : Coefficient :=
  normalizedResidual6Term1Block20 -
    normalizedResidual6Term2Block20 +
    normalizedResidual6Term3Block20

theorem recurrence6ResidualBand20_eq : recurrence6ResidualBand20 = 0 := by
...
def recurrence6ResidualBand21 : Coefficient :=
  normalizedResidual6Term1Block21 -
    normalizedResidual6Term2Block21 +
    normalizedResidual6Term3Block21

theorem recurrence6ResidualBand21_eq : recurrence6ResidualBand21 = 0 := by
...
def recurrence6ResidualBand22 : Coefficient :=
  normalizedResidual6Term1Block22 -
    normalizedResidual6Term2Block22 +
    normalizedResidual6Term3Block22

theorem recurrence6ResidualBand22_eq : recurrence6ResidualBand22 = 0 := by
...
def recurrence6ResidualBand23 : Coefficient :=
  normalizedResidual6Term1Block23 -
    normalizedResidual6Term2Block23 +
    normalizedResidual6Term3Block23

theorem recurrence6ResidualBand23_eq : recurrence6ResidualBand23 = 0 := by
...
def recurrence6ResidualBand24 : Coefficient :=
  normalizedResidual6Term1Block24 -
    normalizedResidual6Term2Block24 +
    normalizedResidual6Term3Block24

theorem recurrence6ResidualBand24_eq : recurrence6ResidualBand24 = 0 := by
...
def recurrence6ResidualBand25 : Coefficient :=
  normalizedResidual6Term1Block25 -
    normalizedResidual6Term2Block25 +
    normalizedResidual6Term3Block25

theorem recurrence6ResidualBand25_eq : recurrence6ResidualBand25 = 0 := by
...
def recurrence6ResidualBand26 : Coefficient :=
  normalizedResidual6Term1Block26 -
    normalizedResidual6Term2Block26 +
    normalizedResidual6Term3Block26

theorem recurrence6ResidualBand26_eq : recurrence6ResidualBand26 = 0 := by
...
def recurrence6ResidualBand27 : Coefficient :=
  normalizedResidual6Term1Block27 -
    normalizedResidual6Term2Block27 +
    normalizedResidual6Term3Block27

theorem recurrence6ResidualBand27_eq : recurrence6ResidualBand27 = 0 := by
...
def recurrence6ResidualBand28 : Coefficient :=
  normalizedResidual6Term1Block28 -
    normalizedResidual6Term2Block28 +
    normalizedResidual6Term3Block28

theorem recurrence6ResidualBand28_eq : recurrence6ResidualBand28 = 0 := by
...
def recurrence6ResidualBand29 : Coefficient :=
  normalizedResidual6Term1Block29 -
    normalizedResidual6Term2Block29 +
    normalizedResidual6Term3Block29

theorem recurrence6ResidualBand29_eq : recurrence6ResidualBand29 = 0 := by
...
def recurrence6ResidualBand30 : Coefficient :=
  normalizedResidual6Term1Block30 -
    normalizedResidual6Term2Block30 +
    normalizedResidual6Term3Block30

theorem recurrence6ResidualBand30_eq : recurrence6ResidualBand30 = 0 := by
...
def recurrence6ResidualBand31 : Coefficient :=
  normalizedResidual6Term1Block31 -
    normalizedResidual6Term2Block31 +
    normalizedResidual6Term3Block31

theorem recurrence6ResidualBand31_eq : recurrence6ResidualBand31 = 0 := by
...
def recurrence6ResidualBand32 : Coefficient :=
  normalizedResidual6Term1Block32 -
    normalizedResidual6Term2Block32 +
    normalizedResidual6Term3Block32

theorem recurrence6ResidualBand32_eq : recurrence6ResidualBand32 = 0 := by
...
def recurrence6ResidualBand33 : Coefficient :=
  normalizedResidual6Term1Block33 -
    normalizedResidual6Term2Block33 +
    normalizedResidual6Term3Block33

theorem recurrence6ResidualBand33_eq : recurrence6ResidualBand33 = 0 := by
...
def recurrence6ResidualBand34 : Coefficient :=
  normalizedResidual6Term1Block34 -
    normalizedResidual6Term2Block34 +
    normalizedResidual6Term3Block34

theorem recurrence6ResidualBand34_eq : recurrence6ResidualBand34 = 0 := by
...
def recurrence6ResidualBand35 : Coefficient :=
  normalizedResidual6Term1Block35 -
    normalizedResidual6Term2Block35 +
    normalizedResidual6Term3Block35

theorem recurrence6ResidualBand35_eq : recurrence6ResidualBand35 = 0 := by
...
def recurrence6ResidualBands : Coefficient :=
