...
import MazurTorsion.Kubert.OrderTwentyFiveUnitRelationFactorData
...
private theorem term0_expansion (r s : ℚ) :
  ...
  simp only [term0, term0Expanded, term0C0, term0C1, term0C2, term0C3, term0C4, term0C5, term0C6,
    ...
    term0C17, term0C18, term0C19, term0C20, A, B, C, K, D, E, G, T, P6]
  ring
...
private theorem term1_expansion (r s : ℚ) :
  ...
  simp only [term1, term1Expanded, term1C0, term1C1, term1C2, term1C3, term1C4, term1C5, term1C6,
    ...
    term1C17, term1C18, term1C19, B, C, K, D, J, M]
  ring
...
private theorem term2_expansion (r s : ℚ) :
  ...
  simp only [term2, term2Expanded, term2C0, term2C1, term2C2, term2C3, term2C4, term2C5, term2C6,
    ...
    term2C17, term2C18, term2C19, term2C20, A, B, C, K, D, E, G, J, T, P6]
  ring
...
private theorem term3_expansion (r s : ℚ) :
  ...
  simp only [term3, term3Expanded, term3C0, term3C1, term3C2, term3C3, term3C4, term3C5, term3C6,
    ...
    term3C17, term3C18, term3C19, term3C20, A, B, C, K, D, E, G, L, T, P6]
  ring
...
private theorem terms_eq_lhs (r s : ℚ) :
  ...
  simp only [term0Expanded, term1Expanded, term2Expanded, term3Expanded, lhs, lhsC0, lhsC1, lhsC2,
    ...
    lhsC16, lhsC17, lhsC18, lhsC19, lhsC20]
  ring
...
private theorem convolution_eq_numerator (r s : ℚ) :
  ...
  simp only [convolution, numerator, conv_coefficient_0, conv_coefficient_1, conv_coefficient_2,
    ...
    conv_coefficient_19, conv_coefficient_20]
...
/-- Exact coefficient certificate for the second cyclic unit relation,
stated over the shared public factor data. -/
theorem orderTwentyFiveUnitRelationTwoCertificate
    (r s : ℚ) (hr : r ≠ 0)
    (hA : OrderTwentyFiveUnitRelationFactorData.A r s ≠ 0)
    (hB : OrderTwentyFiveUnitRelationFactorData.B r s ≠ 0)
    (hC : OrderTwentyFiveUnitRelationFactorData.C r s ≠ 0)
    (hK : OrderTwentyFiveUnitRelationFactorData.K r s ≠ 0)
    (hD : OrderTwentyFiveUnitRelationFactorData.D r s ≠ 0)
    (hE : OrderTwentyFiveUnitRelationFactorData.E r s ≠ 0)
    (hL : OrderTwentyFiveUnitRelationFactorData.L r s ≠ 0)
    (hJ : OrderTwentyFiveUnitRelationFactorData.J r s ≠ 0)
    (hP6 : OrderTwentyFiveUnitRelationFactorData.P6 r s ≠ 0)
    (hF : OrderTwentyFiveUnitRelationFactorData.F r s = 0) :
    OrderTwentyFiveUnitRelationFactorData.y4 r s -
        OrderTwentyFiveUnitRelationFactorData.y2 r s -
      OrderTwentyFiveUnitRelationFactorData.y4 r s *
        OrderTwentyFiveUnitRelationFactorData.y1 r s *
        (OrderTwentyFiveUnitRelationFactorData.y8 r s -
          OrderTwentyFiveUnitRelationFactorData.y4 r s) = 0 := by
  change A r s ≠ 0 at hA
  change B r s ≠ 0 at hB
  change C r s ≠ 0 at hC
  change K r s ≠ 0 at hK
  change D r s ≠ 0 at hD
  change E r s ≠ 0 at hE
  change L r s ≠ 0 at hL
  change J r s ≠ 0 at hJ
  change P6 r s ≠ 0 at hP6
  change F r s = 0 at hF
  change y4 r s - y2 r s - y4 r s * y1 r s * (y8 r s - y4 r s) = 0
