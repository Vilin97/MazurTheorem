...
private theorem recurrence2Scalar2Exceptional_coeff_378_prefix_zero :
    (∑ x ∈ Finset.range 192,
      recurrence2ExceptionalProduct.coeff x * remainder4Coefficient2.coeff (378 - x)) =
      0 := by
  apply Finset.sum_eq_zero
  intro x hx
  rw [recurrence2C2_coeff_high (378 - x) (by
    simp only [Finset.mem_range] at hx
    omega)]
  norm_num

private theorem recurrence2Scalar2Exceptional_coeff_378_suffix_zero :
    (∑ x ∈ Finset.range 185,
      recurrence2ExceptionalProduct.coeff (194 + x) *
        remainder4Coefficient2.coeff (378 - (194 + x))) =
      0 := by
  apply Finset.sum_eq_zero
  intro x hx
...
theorem recurrence2Scalar2Exceptional_coeff_378 :
    recurrence2Scalar2Exceptional.coeff 378 =
      (-1855096176165460936 : ℚ) := by
...
private theorem recurrence2Scalar2Exceptional_coeff_379_prefix_zero :
    (∑ x ∈ Finset.range 193,
      recurrence2ExceptionalProduct.coeff x * remainder4Coefficient2.coeff (379 - x)) =
      0 := by
  apply Finset.sum_eq_zero
  intro x hx
  rw [recurrence2C2_coeff_high (379 - x) (by
    simp only [Finset.mem_range] at hx
    omega)]
  norm_num

private theorem recurrence2Scalar2Exceptional_coeff_379_suffix_zero :
    (∑ x ∈ Finset.range 186,
      recurrence2ExceptionalProduct.coeff (194 + x) *
        remainder4Coefficient2.coeff (379 - (194 + x))) =
      0 := by
  apply Finset.sum_eq_zero
  intro x hx
  rw [recurrence2ExceptionalProduct_coeff_high (194 + x) (by omega)]
...
theorem recurrence2Scalar2Exceptional_coeff_379 :
    recurrence2Scalar2Exceptional.coeff 379 =
      (-1255012469 : ℚ) := by
  unfold recurrence2Scalar2Exceptional
  rw [Polynomial.coeff_mul]
  rw [Finset.Nat.sum_antidiagonal_eq_sum_range_succ_mk]
