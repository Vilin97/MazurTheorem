...
/-!
# A checked certificate for the third raw order-25 orbit relation
...
namespace MazurTorsion.Kubert.OrderTwentyFiveRelationTwoCertificate.Internal
...
private theorem unit_relation_two
    (r s : ℚ) (hr : r ≠ 0) (hA : A r s ≠ 0) (hB : B r s ≠ 0)
    (hC : C r s ≠ 0) (hK : K r s ≠ 0) (hD : D r s ≠ 0)
    (hE : E r s ≠ 0) (hL : L r s ≠ 0) (hJ : J r s ≠ 0)
    (hP6 : P6 r s ≠ 0) (hF : F r s = 0) :
...
end MazurTorsion.Kubert.OrderTwentyFiveRelationTwoCertificate.Internal

namespace MazurTorsion.Kubert.OrderTwentyFiveRelationTwoCertificate

open OrderTwentyFiveRawOrbitFactorCertificate

/-- Sutherland's raw equation and the nonvanishing denominators of the first,
second, fourth, and eighth Lécacheux units imply the third cyclic raw-orbit
relation. -/
theorem _root_.MazurTorsion.Kubert.orderTwentyFiveRawOrbit_relationTwo_eq_zero
    (r s : ℚ) (hr : r ≠ 0)
  ...
  have hKI := hK
  change Internal.K r s ≠ 0 at hKI
  have hDI := hD
  ...
  have hu2 :=
    Internal.unit_relation_two r s hr hAI hBI hCI hKI hDI hEI hLI hJI hP6I hFI
  rw [← hyOneI, ← hyTwoI, ← hyFourI, ← hyEightI] at hu2
  simp only [orderTwentyFiveOrbitRelationTwo,
    orderTwentyFiveRawOrbitXZero,
    orderTwentyFiveRawOrbitXTwo, orderTwentyFiveRawOrbitXThree,
    orderTwentyFiveRawOrbitXFour]
  linear_combination orderTwentyFiveRawOrbitYNine r s * hu2

end MazurTorsion.Kubert.OrderTwentyFiveRelationTwoCertificate
