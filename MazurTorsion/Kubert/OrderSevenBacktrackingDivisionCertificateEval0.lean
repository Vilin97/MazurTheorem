...
private lemma eval_0 (d : ℚ) :
    DivisionEvalCertificate d 0 := by
...
private lemma eval_1 (d : ℚ) :
    DivisionEvalCertificate d 1 := by
  unfold DivisionEvalCertificate
  rw [quotient_prePsiSeven]
  simp [dualKernelPolynomial,
        divisionCofactor0,
...
private lemma eval_2 (d : ℚ) :
    DivisionEvalCertificate d 2 := by
  unfold DivisionEvalCertificate
  rw [quotient_prePsiSeven]
  simp [dualKernelPolynomial,
        divisionCofactor0,
...
private lemma eval_3 (d : ℚ) :
    DivisionEvalCertificate d 3 := by
  unfold DivisionEvalCertificate
  rw [quotient_prePsiSeven]
  simp [dualKernelPolynomial,
        divisionCofactor0,
...
private lemma eval_4 (d : ℚ) :
    DivisionEvalCertificate d 4 := by
  unfold DivisionEvalCertificate
  rw [quotient_prePsiSeven]
  simp [dualKernelPolynomial,
        divisionCofactor0,
...
public theorem divisionEvalBlock0 (d : ℚ) (i : Fin 5) :
    DivisionEvalCertificate d ((i : ℚ) + 0) := by
  fin_cases i
