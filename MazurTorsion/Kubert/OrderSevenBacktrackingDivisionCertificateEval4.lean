...
private lemma eval_20 (d : ℚ) :
    DivisionEvalCertificate d 20 := by
...
private lemma eval_21 (d : ℚ) :
    DivisionEvalCertificate d 21 := by
  unfold DivisionEvalCertificate
  rw [quotient_prePsiSeven]
  simp [dualKernelPolynomial,
        divisionCofactor0,
...
private lemma eval_22 (d : ℚ) :
    DivisionEvalCertificate d 22 := by
  unfold DivisionEvalCertificate
  rw [quotient_prePsiSeven]
  simp [dualKernelPolynomial,
        divisionCofactor0,
...
private lemma eval_23 (d : ℚ) :
    DivisionEvalCertificate d 23 := by
  unfold DivisionEvalCertificate
  rw [quotient_prePsiSeven]
  simp [dualKernelPolynomial,
        divisionCofactor0,
...
private lemma eval_24 (d : ℚ) :
    DivisionEvalCertificate d 24 := by
  unfold DivisionEvalCertificate
  rw [quotient_prePsiSeven]
  simp [dualKernelPolynomial,
        divisionCofactor0,
