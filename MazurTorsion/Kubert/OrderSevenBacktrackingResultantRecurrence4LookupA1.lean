...
-/
module
public import MazurTorsion.Kubert.OrderSevenBacktrackingResultantRecurrence4LookupA1Low
public import MazurTorsion.Kubert.OrderSevenBacktrackingResultantRecurrence4LookupA1High
import Mathlib.Tactic.NormNum
import Lean.Elab.Tactic.Omega

/-!
# Recurrence 4 lookup certificate: A1 source bound
...
theorem recurrence4A1_coeff_high (n : ℕ) (h : 190 < n) :
  ...
  rw [recurrence4A1_remainder4Coefficient1Chunk0_coeff_high n h]
  rw [recurrence4A1_remainder4Coefficient1Chunk1_coeff_high n h]
  rw [recurrence4A1_remainder4Coefficient1Chunk2_coeff_high n h]
  rw [recurrence4A1_remainder4Coefficient1Chunk3_coeff_high n h]
  rw [recurrence4A1_remainder4Coefficient1Chunk4_coeff_high n h]
  rw [recurrence4A1_remainder4Coefficient1Chunk5_coeff_high n h]
  rw [recurrence4A1_remainder4Coefficient1Chunk6_coeff_high n h]
  rw [recurrence4A1_remainder4Coefficient1Chunk7_coeff_high n h]
  rw [recurrence4A1_remainder4Coefficient1Chunk8_coeff_high n h]
  rw [recurrence4A1_remainder4Coefficient1Chunk9_coeff_high n h]
  rw [recurrence4A1_remainder4Coefficient1Chunk10_coeff_high n h]
  rw [recurrence4A1_remainder4Coefficient1Chunk11_coeff_high n h]
  rw [recurrence4A1_remainder4Coefficient1Chunk12_coeff_high n h]
  rw [recurrence4A1_remainder4Coefficient1Chunk13_coeff_high n h]
  rw [recurrence4A1_remainder4Coefficient1Chunk14_coeff_high n h]
  rw [recurrence4A1_remainder4Coefficient1Chunk15_coeff_high n h]
  rw [recurrence4A1_remainder4Coefficient1Chunk16_coeff_high n h]
  rw [recurrence4A1_remainder4Coefficient1Chunk17_coeff_high n h]
  rw [recurrence4A1_remainder4Coefficient1Chunk18_coeff_high n h]
  rw [recurrence4A1_remainder4Coefficient1Chunk19_coeff_high n h]
  rw [recurrence4A1_remainder4Coefficient1Chunk20_coeff_high n h]
  rw [recurrence4A1_remainder4Coefficient1Chunk21_coeff_high n h]
  rw [recurrence4A1_remainder4Coefficient1Chunk22_coeff_high n h]
  rw [recurrence4A1_remainder4Coefficient1Chunk23_coeff_high n h]
  norm_num
...
theorem recurrence4A1_natDegree_le :
  ...
  exact Polynomial.natDegree_le_iff_coeff_eq_zero.mpr
    recurrence4A1_coeff_high

theorem recurrence4A1_coeff_low (n : ℕ) (h : n < 1) :
    remainder4Coefficient1.coeff n = 0 := by
  have hn : n = 0 := by omega
  subst n
  simpa only using recurrence4A1_coeff_0
