...
-/
module
public import MazurTorsion.Kubert.OrderSevenBacktrackingDivisionCertificateEval0
import Mathlib.Tactic.Ring

/-!
# Division-factor evaluation shard 1
...
private lemma eval_5 (d : ℚ) :
    DivisionEvalCertificate d 5 := by
...
private lemma eval_6 (d : ℚ) :
    DivisionEvalCertificate d 6 := by
  unfold DivisionEvalCertificate
  rw [quotient_prePsiSeven]
  simp [dualKernelPolynomial,
        divisionCofactor0,
...
private lemma eval_7 (d : ℚ) :
    DivisionEvalCertificate d 7 := by
  unfold DivisionEvalCertificate
  rw [quotient_prePsiSeven]
  simp [dualKernelPolynomial,
        divisionCofactor0,
...
private lemma eval_8 (d : ℚ) :
    DivisionEvalCertificate d 8 := by
  unfold DivisionEvalCertificate
  rw [quotient_prePsiSeven]
  simp [dualKernelPolynomial,
        divisionCofactor0,
...
private lemma eval_9 (d : ℚ) :
    DivisionEvalCertificate d 9 := by
  unfold DivisionEvalCertificate
  rw [quotient_prePsiSeven]
  simp [dualKernelPolynomial,
        divisionCofactor0,
...
public theorem divisionEvalBlock1 (d : ℚ) (i : Fin 5) :
    DivisionEvalCertificate d ((i : ℚ) + 5) := by
  fin_cases i
