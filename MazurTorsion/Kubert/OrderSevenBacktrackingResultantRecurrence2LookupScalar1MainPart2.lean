...
private theorem recurrence2Scalar1Main_coeff_381_prefix_zero :
    (∑ x ∈ Finset.range 148,
      remainder3Coefficient1.coeff x * recurrence2QuotientConstant.coeff (381 - x)) =
      0 := by
...
private theorem recurrence2Scalar1Main_coeff_381_suffix_zero :
    (∑ x ∈ Finset.range 231,
      remainder3Coefficient1.coeff (151 + x) *
        recurrence2QuotientConstant.coeff (381 - (151 + x))) =
      0 := by
  apply Finset.sum_eq_zero
  intro x hx
...
theorem recurrence2Scalar1Main_coeff_381 :
    recurrence2Scalar1Main.coeff 381 =
      (76364678739432121013972570 : ℚ) := by
...
private theorem recurrence2Scalar1Main_coeff_382_prefix_zero :
    (∑ x ∈ Finset.range 149,
      remainder3Coefficient1.coeff x * recurrence2QuotientConstant.coeff (382 - x)) =
      0 := by
  apply Finset.sum_eq_zero
  intro x hx
...
private theorem recurrence2Scalar1Main_coeff_382_suffix_zero :
    (∑ x ∈ Finset.range 232,
      remainder3Coefficient1.coeff (151 + x) *
        recurrence2QuotientConstant.coeff (382 - (151 + x))) =
      0 := by
  apply Finset.sum_eq_zero
  intro x hx
  rw [recurrence2B1_coeff_high (151 + x) (by omega)]
...
theorem recurrence2Scalar1Main_coeff_382 :
    recurrence2Scalar1Main.coeff 382 =
      (-151675326639786480 : ℚ) := by
  unfold recurrence2Scalar1Main
  rw [Polynomial.coeff_mul]
  rw [Finset.Nat.sum_antidiagonal_eq_sum_range_succ_mk]
  norm_num only [Nat.succ_eq_add_one]
...
private theorem recurrence2Scalar1Main_coeff_383_prefix_zero :
    (∑ x ∈ Finset.range 150,
      remainder3Coefficient1.coeff x * recurrence2QuotientConstant.coeff (383 - x)) =
      0 := by
  apply Finset.sum_eq_zero
  intro x hx
...
private theorem recurrence2Scalar1Main_coeff_383_suffix_zero :
    (∑ x ∈ Finset.range 233,
      remainder3Coefficient1.coeff (151 + x) *
        recurrence2QuotientConstant.coeff (383 - (151 + x))) =
      0 := by
  apply Finset.sum_eq_zero
  intro x hx
  rw [recurrence2B1_coeff_high (151 + x) (by omega)]
...
theorem recurrence2Scalar1Main_coeff_383 :
    recurrence2Scalar1Main.coeff 383 =
      (56415748 : ℚ) := by
  unfold recurrence2Scalar1Main
  rw [Polynomial.coeff_mul]
  rw [Finset.Nat.sum_antidiagonal_eq_sum_range_succ_mk]
