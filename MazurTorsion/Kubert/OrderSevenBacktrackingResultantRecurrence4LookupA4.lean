...
-/
module
public import MazurTorsion.Kubert.OrderSevenBacktrackingResultantRecurrence4LookupA4Low
public import MazurTorsion.Kubert.OrderSevenBacktrackingResultantRecurrence4LookupA4High
import Mathlib.Tactic.NormNum
import Lean.Elab.Tactic.Omega

/-!
# Recurrence 4 lookup certificate: A4 source bound
...
theorem recurrence4A4_coeff_high (n : ℕ) (h : 178 < n) :
  ...
  rw [recurrence4A4_remainder4Coefficient4Chunk0_coeff_high n h]
  rw [recurrence4A4_remainder4Coefficient4Chunk1_coeff_high n h]
  rw [recurrence4A4_remainder4Coefficient4Chunk2_coeff_high n h]
  rw [recurrence4A4_remainder4Coefficient4Chunk3_coeff_high n h]
  rw [recurrence4A4_remainder4Coefficient4Chunk4_coeff_high n h]
  rw [recurrence4A4_remainder4Coefficient4Chunk5_coeff_high n h]
  rw [recurrence4A4_remainder4Coefficient4Chunk6_coeff_high n h]
  rw [recurrence4A4_remainder4Coefficient4Chunk7_coeff_high n h]
  rw [recurrence4A4_remainder4Coefficient4Chunk8_coeff_high n h]
  rw [recurrence4A4_remainder4Coefficient4Chunk9_coeff_high n h]
  rw [recurrence4A4_remainder4Coefficient4Chunk10_coeff_high n h]
  rw [recurrence4A4_remainder4Coefficient4Chunk11_coeff_high n h]
  rw [recurrence4A4_remainder4Coefficient4Chunk12_coeff_high n h]
  rw [recurrence4A4_remainder4Coefficient4Chunk13_coeff_high n h]
  rw [recurrence4A4_remainder4Coefficient4Chunk14_coeff_high n h]
  rw [recurrence4A4_remainder4Coefficient4Chunk15_coeff_high n h]
  rw [recurrence4A4_remainder4Coefficient4Chunk16_coeff_high n h]
  rw [recurrence4A4_remainder4Coefficient4Chunk17_coeff_high n h]
  rw [recurrence4A4_remainder4Coefficient4Chunk18_coeff_high n h]
  rw [recurrence4A4_remainder4Coefficient4Chunk19_coeff_high n h]
  rw [recurrence4A4_remainder4Coefficient4Chunk20_coeff_high n h]
  rw [recurrence4A4_remainder4Coefficient4Chunk21_coeff_high n h]
  rw [recurrence4A4_remainder4Coefficient4Chunk22_coeff_high n h]
  norm_num
