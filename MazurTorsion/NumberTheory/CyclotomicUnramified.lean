...
ring of integers. -/
noncomputable def classGroupAutomorphism (p : ℕ) [Fact p.Prime]
...
/-- The missing class-field-theory statement: every everywhere-unramified
inverse-cyclotomic extension produces the corresponding class-group
quotient. -/
...
theorem noEverywhereUnramified
    ...
    ¬ E.IsUnramifiedAtFinitePlaces := by
  intro hunramified
  exact hclassGroup (hclassField E hunramified)
