...
arbitrary `WeierstrassGroupSchemeInterface` input. Thus both the group-scheme
and exact-torsion subgroup packages are integrated; the represented cyclic
quotient is the selected next package.
