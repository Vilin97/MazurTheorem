...
- canonical coherent-cohomology actions, finite-free proper-curve low-degree
  targets, finite strict-support thickenings, and open-local support-comodel
  assembly, one Weierstrass secant chart, and the represented polynomial-cusp
  collision are recorded as checked prerequisites without promoting them to
  Riemann--Roch, a group scheme, or represented `X₀`; and
