...
every selected occurrence graph a section.  The precise remaining step is
to prove that this base open contains the exact lifted divisor point, shrink
