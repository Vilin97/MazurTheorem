...
intact.  The precise remaining step is to take the finite union of these
transported opens within each support-indexed ambient, assemble those
supportwise opens in the common curve-family coproduct, choose the required
affine neighbourhoods there, and identify the resulting section-ring
coordinate maps with the affine base change of the universal graph-product
algebra.  Only after this simultaneous geometric transport theorem may the
