...
the restricted selected graph ideal.  The precise remaining step is to prove
that this base open contains the exact lifted divisor point, shrink
to affine subneighbourhoods there, assemble the support pieces in the common
