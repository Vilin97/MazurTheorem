...
`simultaneousBaseOpen`.  The precise remaining step is to shrink to affine
subneighbourhoods there, assemble the support pieces in the common
curve-family coproduct, and identify the resulting section-ring coordinate
