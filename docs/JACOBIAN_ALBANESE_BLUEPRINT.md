...
image.  The remaining local work is to extract its sheet tuple and orbit
component and connect their multiplicities to the assigned occurrence
fibers before applying the monic-root algebra.
