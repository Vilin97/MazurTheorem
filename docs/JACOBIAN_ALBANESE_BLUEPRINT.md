...
`i` is its assigned geometric-support member.  This will turn those sheet
fibers into the intended repeated graph-factor multiplicities before the
monic-root algebra is applied.
