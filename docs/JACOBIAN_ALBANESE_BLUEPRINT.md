...
equal-coordinate ideal with the genuine graph ideal.  The precise remaining
step is therefore to construct one affine common refinement of the finitely
many occurrence opens over the coherent chart and identify its section-ring
coordinate map with `orderedAmbientCoordinateHom`.  Only after this geometric
