...
principal effective Cartier divisor.  The next step is to transport this
model through étale coordinates on a smooth curve, identify it with the
pointed symmetric-power/incidence morphism, and descend the Cartier property.
