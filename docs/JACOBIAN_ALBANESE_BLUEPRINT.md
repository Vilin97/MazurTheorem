...
étale occurrence-coordinate morphism, identify each restricted curve-level
graph ideal as the extension of its affine-line section ideal, prove the
intersection-quotient comparison for the finite union of those sections, and
descend the resulting isomorphism to the actual curve quotient.  The
