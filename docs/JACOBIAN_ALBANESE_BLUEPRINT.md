...
ordered linear factors in that sheet.  What remains in this local layer is
to present the restricted ordered incidence algebra as the corresponding
sheetwise product of universal monic root algebras and transport its
stabilizer action through that presentation.
