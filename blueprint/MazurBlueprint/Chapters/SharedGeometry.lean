...
:::theorem "MT-EC-ISOGENY-WEIL" (parent := "shared_geometry") (uses := "MT-BASE-INTEGRATED") (tags := "infrastructure, planned, nouns-missing, mixed")
...
*Summary:* Package the rational cyclic subgroup generated by a torsion point, the
quotient isogeny interfaces used by X\_0 and the existing order-49 lane, and only the
kernel/base-change laws exercised by those consumers.
