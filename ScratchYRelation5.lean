...
private theorem term0_expansion (r s : ℚ) :
  ...
  simp only [term0, term0Expanded, term0C0, term0C1, term0C2, term0C3, term0C4, term0C5, term0C6, term0C7, term0C8, term0C9, term0C10, term0C11, term0C12, term0C13, term0C14, term0C15, term0C16, term0C17, term0C18, B, K, T, M, N]
  ring
...
private theorem term1_expansion (r s : ℚ) :
  ...
  simp only [term1, term1Expanded, term1C0, term1C1, term1C2, term1C3, term1C4, term1C5, term1C6, term1C7, term1C8, term1C9, term1C10, term1C11, term1C12, term1C13, term1C14, term1C15, term1C16, term1C17, term1C18, term1C19, A, B, C, K, D, E, G, L, P6, P9]
  ring
...
private theorem F_mul_Q_eq_convolution (r s : ℚ) :
  ...
  simp only [F, Q, convolution, convC0, convC1, convC2, convC3, convC4, convC5, convC6, convC7, convC8, convC9, convC10, convC11, convC12, convC13, convC14, convC15, convC16, convC17, convC18, convC19]
  ring

private theorem convolution_eq_numerator (r s : ℚ) :
    convolution r s = numerator r s := by
  simp only [convolution, numerator, conv_coefficient_0, conv_coefficient_1, conv_coefficient_2, conv_coefficient_3, conv_coefficient_4, conv_coefficient_5, conv_coefficient_6, conv_coefficient_7, conv_coefficient_8, conv_coefficient_9, conv_coefficient_10, conv_coefficient_11, conv_coefficient_12, conv_coefficient_13, conv_coefficient_14, conv_coefficient_15, conv_coefficient_16, conv_coefficient_17, conv_coefficient_18, conv_coefficient_19]
...
theorem relation_5
    (r s : ℚ) (hs : s ≠ 0) (hA : A r s ≠ 0) (hC : C r s ≠ 0) (hD : D r s ≠ 0) (hE : E r s ≠ 0) (hL : L r s ≠ 0) (hJ : J r s ≠ 0) (hP6 : P6 r s ≠ 0) (hP9 : P9 r s ≠ 0)
    (hF : F r s = 0) :
