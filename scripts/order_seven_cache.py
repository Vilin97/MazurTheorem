...
SHARDS.update(
    {
        ...
        "r2-scalars-0": recurrence_shard(
            2,
            targets=("Scalar1Main", "Scalar1Shift", "Scalar3Exceptional", "Scalar2Left", "Scalar3Left"),
            artifacts=("Scalar1Main*", "Scalar1Shift*", "Scalar3Exceptional*", "Scalar2Left*", "Scalar3Left*"),
            predecessors=("r2-base-a", "r2-base-b", "r2-base-c", "r2-products-a", "r2-products-b"),
        ),
        "r2-scalars-1": recurrence_shard(
            2,
            targets=("Scalar1Exceptional", "Scalar2Exceptional", "Scalar0Left", "Scalar4Main", "Scalar4Left"),
            artifacts=("Scalar1Exceptional*", "Scalar2Exceptional*", "Scalar0Left*", "Scalar4Main*", "Scalar4Left*"),
            predecessors=("r2-base-a", "r2-base-b", "r2-base-c", "r2-products-a", "r2-products-b"),
        ),
        "r2-scalars-2": recurrence_shard(
            2,
            targets=("Scalar0Exceptional", "Scalar2Main", "Scalar3Shift", "Scalar1Left", "Scalar4Exceptional"),
            artifacts=("Scalar0Exceptional*", "Scalar2Main*", "Scalar3Shift*", "Scalar1Left*", "Scalar4Exceptional*"),
            predecessors=("r2-base-a", "r2-base-b", "r2-base-c", "r2-products-a", "r2-products-b"),
        ),
        "r2-scalars-3": recurrence_shard(
            2,
            targets=("Scalar0Main", "Scalar3Main", "Scalar2Shift", "Scalar4Shift"),
            artifacts=("Scalar0Main*", "Scalar3Main*", "Scalar2Shift*", "Scalar4Shift*"),
            predecessors=("r2-base-a", "r2-base-b", "r2-base-c", "r2-products-a", "r2-products-b"),
        ),
        "r4-scalars-0": recurrence_shard(
            4,
            targets=("Scalar2Left", "Scalar1Left", "Scalar2Exceptional"),
            artifacts=("Scalar2Left*", "Scalar1Left*", "Scalar2Exceptional*"),
            predecessors=("r4-base-a", "r4-base-b", "r4-base-c", "r4-products-a", "r4-products-b"),
        ),
        "r4-scalars-1": recurrence_shard(
            4,
            targets=("Scalar0Left", "Scalar1Second", "Scalar2First"),
            artifacts=("Scalar0Left*", "Scalar1Second*", "Scalar2First*"),
            predecessors=("r4-base-a", "r4-base-b", "r4-base-c", "r4-products-a", "r4-products-b"),
        ),
        "r4-scalars-2": recurrence_shard(
            4,
            targets=("Scalar1First", "Scalar0Exceptional", "Scalar2Second"),
            artifacts=("Scalar1First*", "Scalar0Exceptional*", "Scalar2Second*"),
            predecessors=("r4-base-a", "r4-base-b", "r4-base-c", "r4-products-a", "r4-products-b"),
        ),
        ...
        "r5-scalars-0": recurrence_shard(
            5,
            targets=("Scalar0Main", "Scalar1First", "Scalar1Exceptional"),
            artifacts=("Scalar0Main*", "Scalar1First*", "Scalar1Exceptional*"),
        ...
        "r2-final": recurrence_shard(
            ...
            predecessors=("r2-scalars-0", "r2-scalars-1", "r2-scalars-2", "r2-scalars-3"),
        ),
        "r4-final": recurrence_shard(
            4,
            targets=("",),
            artifacts=("Scalar", ""),
            predecessors=("r4-scalars-0", "r4-scalars-1", "r4-scalars-2", "r4-scalars-3"),
        ),
        "r5-final": recurrence_shard(
            5,
            targets=("",),
            artifacts=("Scalar", ""),
            predecessors=("r5-scalars-0", "r5-scalars-1", "r5-scalars-2"),
        ),
    }
)
