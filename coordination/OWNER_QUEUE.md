...
2. `MT-X0-INTEGRAL` (30): compactification and cusp neighbourhoods only in
   ...
   vector and proves formal immersion of `Spec.map`. Next construct the
   represented integral cusp chart and its actual section, cusp prime,
   generator and non-square proofs, both residue surjections, and the modular
   quotient q-expansion identity; no coefficient-field hypothesis remains at
   that handoff.
