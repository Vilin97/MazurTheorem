...
through the checked quotient-`H⁰` and kernel-`H¹` reverse inclusions to the
remaining middle-`H¹` reverse inclusion and the focused rank-zero consumer.
